...
| **Full position coverage — TQB/K/DST** | ✅ MERGED (`26031e8`) — 790 tests. All eight lineup slots captured and scored |
...
`pass_yds` revert, the duplicate-entity fix, and full position coverage, and the all-13 roster board) is **790 passed**,
